...
//accordeon footer
    $('.block-title.heading').on('click', function(){
    	$(this).toggleClass('active');
    	$(this).next().slideToggle();
    });
//accordeon tabs
    $('.detail-product-tab .title-tab-pane').on('click', function(){
    	$(this).toggleClass('active');
    	$(this).next().slideToggle();
    });

//accordeon footer
    $('.header .block-title').on('click', function(){
    	$(this).toggleClass('active');
    	$(this).next().slideToggle();
    });
...
//          $(".block-content").removeClass(".active").addClass("art");
//  }
//});


//accordeon menu
    $('a.mobnav-trigger').on('click', function(){
    	event.preventDefault();
    	$('.main-nav').slideToggle();
    	$('.middle-colum').css('display','none');
    	$('.account.skip-content').css('display','none');
    	$('.inner-cart-info.mob').css('display','none');
    });

//accordeon search
    $('a.skip-search').on('click', function(){
    	event.preventDefault();
    	$('.middle-colum').slideToggle();
...
//accordeon user
    $('a.skip-account').on('click', function(){
    	event.preventDefault();
    	$('#header-account.account').slideToggle();
    	$('.middle-colum').css('display','none');
    	$('.main-nav').css('display','none');
    	$('.inner-cart-info.mob').css('display','none');
    });
//accordeon cart
    $('a.skip-cart').on('click', function(){
    	event.preventDefault();
    	$('.inner-cart-info.mob').slideToggle();
    	$('.main-nav').css('display','none');   	
    	$('.middle-colum').css('display','none');
    	$('.account.skip-content').css('display','none');
    });
	...
	$('.mobile-collapsible .heading').click(function() {
	    $('.mobile-collapsible .block-content').toggle('no-display');
	});
	...
	if($(window).width()<768){
		...
		$('.main-nav li.menu-item-has-childrent>.fa').click(function(event){ 
			event.stopPropagation();
			$(this).toggleClass('active');
			if($(this).hasClass('active')){
				event.preventDefault();
